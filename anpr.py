#Importer toutes les bibliothèques requises
import json
...
def save_json(license_plates, startTime, endTime):
    #Générer des fichiers JSON individuels pour chaque intervalle de 20 secondes
    interval_data = {
    ...
    #Ajouter les nouvelles données d'intervalle aux données cumulatives
    existing_data.append(interval_data)

    with open(cummulative_file_path, 'w') as f:
        json.dump(existing_data, f, indent = 2)

    #Sauvegarder les données dans la base de données SQL
